...
def _do_ensure_default_agent() -> None:
    ...
    if not agent_existed:
        ...
        default_name = _DEFAULT_AGENT_NAME
        default_description = _DEFAULT_AGENT_DESCRIPTION
        try:
            from ..agentdesk.default_agent import (
            ...
            if is_agentdesk_enabled():
                ...
                default_description = AGENTDESK_DEFAULT_DESCRIPTION
        except ImportError:
            pass
